...
import BillApprovalVisibility from './pages/BillApprovalVisibility'

const NAV = [
  { label: 'Dashboard', path: '/', icon: LayoutDashboard },
  { label: 'Bill Approvals', path: '/feature', icon: ChevronRight },
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-sky-50 border border-sky-200 rounded-lg p-4 text-sm text-sky-800">
        <strong>What was built:</strong> The Financial Integrity Team met with Jess to document long-standing pain points in Varicon that have gone unresolved since May of the previous year. Key issues centre around the three-phase bill approval workflow lacking clear status visibility, a broken approval filter system, GST rounding discrepancies causing incorrect ATO reporting, and persistent bill syncing errors with Xero. Additional concerns included the inability to add notes to submitted Day Works dockets, no user access to view or manage Day Works charge rates, and a missing WBS copy function for bill assignment efficiency.
        <br/><br/>Navigate to <strong>Bill Approvals</strong> in the sidebar to see the prototype.
      </div>
    </div>
  )
}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="/feature" element={<BillApprovalVisibility />} />
